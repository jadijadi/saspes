...
export default {
    ...
    data: () => ({
        ...
        gradeOptions: [...avaliableGrades, "exclude"],
        opened: false,
        width: 100
    }),
    computed: {
    ...
    mounted() {
        this.width = document.querySelector('.hypo-grade-panel').offsetWidth + 1;
    },
    methods: {
        toggleOpen() {
            this.opened = !this.opened;
            if (!this.opened) {
                this.courses = this.beforeMount();
            }
        }
    }
};
